...
// ─── Component ────────────────────────────────────────────────
//
// Patient role's profile editor (Section 1.7.6).
// Per Decision 5: edits ONLY User fields (name/phone/timezone/dob/address) via PUT /auth/me.
// Does NOT touch Recipient fields (medical_tags, emergency contact, lifestyle, etc.) —
// those remain caregiver-managed via home/[recipientId]/edit.tsx.
// Visual mirror of home/profile.tsx with role label changed.
      ...
      <View style={s.card}>
        ...
        <View style={[s.readOnlyRow, { borderBottomWidth: 0 }]}>
          ...
          <View style={s.readOnlyTextWrap}>
            ...
            <Text style={s.readOnlyValue}>被照護者</Text>
          </View>
        </View>
      </View>
